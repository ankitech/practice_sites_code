...
The username consists of  to  characters inclusive. If the username consists of less than  or greater than  characters,
...
character set consisting of lowercase characters , uppercase characters , and digits .
...
The first line of input contains an integer , describing the total number of usernames. Each of the next
